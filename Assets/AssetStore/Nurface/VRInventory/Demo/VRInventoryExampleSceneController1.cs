...
{
    public class VRInventoryExampleSceneController1 : MonoBehaviour
    {
        //  [Range(0, 100)]
        ...
        void Start()
        {
            ...
            scoreUppainel.transform.localScale = Vector3.zero;
        }
       ...
       */
        public void UpdateScore(int newValue = -1)
        {
            ...
            coinsText.text = String.Format("Score:{0}", score);
        }
        ...
        {
            Debug.Log("final missão");
            scoreUp.text = message;
            FadeInScore();
            FadeOutScore();
        }

        private void FadeInScore()
        {
            Debug.Log("final missão1");

            iTween.StopByName(scoreUppainel.gameObject, "fadeInScore");
            iTween.ScaleTo(scoreUppainel.gameObject, iTween.Hash("scale", Vector3.one, "time", 1f, "name", "fadeInScore"));
        }

        private void FadeOutScore()

        {
            Debug.Log("final missão2");

            iTween.StopByName(scoreUppainel.gameObject, "fadeOutScore");
            iTween.ScaleTo(scoreUppainel.gameObject, iTween.Hash("scale", Vector3.zero, "time", 1f, "delay", 4f, "name", "fadeOutScore"));
        }
    }
}
